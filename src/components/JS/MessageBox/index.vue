...
<style scoped>
.messageBox{ width:200px; height:120px; border: 1px solid #ccc; border-radius: 4px; box-shadow: 3px 3px 3px #ccc; background: white; position:absolute; left: 50%; top : 50%; margin: -70px 0 0 -100px;}
