			...
			<div class="detail_list">
				...
				<div class="detail_list_content">
					<div class="detail_list_img">
						<img :src="detailMovie.img | setWH()" alt="">
					</div>
...
export default {
	...
	props : ['movieId'],
	mounted() {
		//通过props获取热映中的点击电影获得的影片的id 然后通过接口文档id来获取当前影片的的详细信息
...
<style scoped>
#detailContainer{position: absolute; left: 0;top: 0; z-index: 100;width: 100%; min-height: 100%; background-color: white;}
